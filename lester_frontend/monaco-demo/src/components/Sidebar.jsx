...
function Sidebar({inputs, setInputs, valid, colour, setColour, testSelection, setTestSelection, regenerateSelection, setRegenerateSelection, handleHighlight, clearHighlights, submitCode, testCodeSubmit, regenerateCodeSubmit, submitError, submitErrorMsg}){
